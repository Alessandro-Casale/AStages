...
//        );
        ...
        dispatcher.register(Commands.literal("astages").requires(c -> c.hasPermission(2))
            .then(Commands.literal("add").then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("stage", StringArgumentType.word()).suggests(AStagesSuggestions.PLAYER_ADD)
            ...
            .then(Commands.literal("add").then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("stage", StringArgumentType.word()).suggests(AStagesSuggestions.PLAYER_ADD).then(Commands.argument("silentChat", BoolArgumentType.bool()).then(Commands.argument("silentTitle", BoolArgumentType.bool())
            ...
            .then(Commands.literal("remove").then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("stage", StringArgumentType.word()).suggests(AStagesSuggestions.PLAYER_REMOVE)
            ...
            .then(Commands.literal("remove").then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("stage", StringArgumentType.word()).suggests(AStagesSuggestions.PLAYER_REMOVE).then(Commands.argument("silentChat", BoolArgumentType.bool()).then(Commands.argument("silentTitle", BoolArgumentType.bool())
